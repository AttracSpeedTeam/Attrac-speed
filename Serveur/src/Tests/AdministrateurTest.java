...
public class AdministrateurTest {
    ...
    public static void beforeClass() throws Exception {
        ...
        attraction = new Attraction("Petit train", 19);
        attraction.setLongueurFile(5);

        attraction2 = new Attraction("Bus magique sans rail", 89);
        attraction3 = new Attraction("Le pic piquant", 5);
    ...
    public void modifImpossible(){
        Attraction attraction4 = new Attraction("Petit rat", 59);
